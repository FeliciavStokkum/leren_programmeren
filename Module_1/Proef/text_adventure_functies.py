...
def welke_richting():
    ...
    print("2. Pad 2 is donker, maar het ziet er wel minder lang uit.")
...
def mysterieuze_geluiden():
    ...
    print("Je hebt de volgende opties:")
    time.sleep(2)
    print("1. je gaat het pad onderzoeken")
...
#vraag glinstering
def glinstering():
    print("Terwijl je een andere route hebt gekozen, zie je een vreemde glinstering in het bos")
    time.sleep(2)
    print("Je hebt de volgende opties:")
    time.sleep(2)
...
#einde dorpeling
def dorpeling():
    print("Je ziet in de verte een verwaalde dorpeling, je beseft dat je doel was om deze te vinden. Gefeliciteerd! Je hebt de dorpeling gevonden.")
...
def welk_pad():
    print("Wanneer je richting het bos loopt zie je dat er 2 paden het bos binnen treden. Het eerste pad is heet schemerig en donker. Ook lijkt het erg onveilig.")
    time.sleep(2)
    print("Het 2e pad ziet erg gezellig en veilig uit. De zon schijnt volop het pad.")
    time.sleep(2)
    print("welk pad ga je lopen?: ")
    time.sleep(2)
